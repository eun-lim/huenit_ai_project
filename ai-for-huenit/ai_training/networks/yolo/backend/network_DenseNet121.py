...
def create_yolo_network_DenseNet121(architecture,
                        input_size,
                        nb_classes,
                        nb_box,
                        nb_stages,
...
class YoloNetwork(object):
    ...
    def __init__(self,
        ...
        grid_size_y, grid_size_x = feature_extractor.get_output_size(layer  = 'conv4_block21_2_conv')
        x1 = feature_extractor.get_output_tensor('conv4_block21_2_conv')
        ...
        if nb_stages == 2:
            ...
            grid_size_y_2, grid_size_x_2 = feature_extractor.get_output_size(layer = 'conv3_block10_2_conv')
            x2 = feature_extractor.get_output_tensor('conv3_block10_2_conv')
            #x1 = _depthwise_conv_block(inputs = x1, alpha = 1, pointwise_conv_filters = 128, block_id=14)
