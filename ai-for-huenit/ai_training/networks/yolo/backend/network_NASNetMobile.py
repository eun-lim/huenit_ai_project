...
def create_yolo_network_NASNetMobile(architecture,
                        input_size,
                        nb_classes,
                        nb_box,
                        nb_stages,
...
class YoloNetwork(object):
    ...
    def __init__(self,
        ...
        grid_size_y, grid_size_x = feature_extractor.get_output_size(layer  = 'reduction_concat_stem_2')
        x1 = feature_extractor.get_output_tensor('reduction_concat_stem_2')
        ...
        if nb_stages == 2:
            ...
            grid_size_y_2, grid_size_x_2 = feature_extractor.get_output_size(layer = 'reduction_concat_stem_1')
            x2 = feature_extractor.get_output_tensor('reduction_concat_stem_1')
            #x1 = _depthwise_conv_block(inputs = x1, alpha = 1, pointwise_conv_filters = 128, block_id=14)
