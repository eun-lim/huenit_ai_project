...
def create_yolo_network_SqueezeNet(architecture,
                        input_size,
                        nb_classes,
                        nb_box,
                        nb_stages,
...
class YoloNetwork(object):
    ...
    def __init__(self,
        ...
        grid_size_y, grid_size_x = feature_extractor.get_output_size(layer  = 'fire9/concat')
        x1 = feature_extractor.get_output_tensor('fire9/concat')
        ...
        if nb_stages == 2:
            ...
            grid_size_y_2, grid_size_x_2 = feature_extractor.get_output_size(layer = 'fire5/concat')
            x2 = feature_extractor.get_output_tensor('fire5/concat')
            #x1 = _depthwise_conv_block(inputs = x1, alpha = 1, pointwise_conv_filters = 128, block_id=14)
