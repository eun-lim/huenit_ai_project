...
MODEL_SAVE_PATH = "/content/save_yolo_model_outputt"
TARGET_LABELS = "Cat Dog"


import sys
sys.path.append('/content/huenit_ai_project/ai-for-huenit')
...
config = {
    ...
    "train" : {
        "actual_epoch":         10,
        "train_image_folder":   "/content/huenit_ai_project/OIDv4_ToolKit/OID/xml_generated/imgs",
        "train_annot_folder":   "/content/huenit_ai_project/OIDv4_ToolKit/OID/xml_generated/anns",
        "train_times":          5,
        "valid_image_folder":   "/content/huenit_ai_project/OIDv4_ToolKit/OID/xml_generated/imgs_validation",
        "valid_annot_folder":   "/content/huenit_ai_project/OIDv4_ToolKit/OID/xml_generated/anns_validation",
        "valid_times":          1,
        "valid_metric":         "recall",
        "batch_size":           32,
        "learning_rate":        1e-3,
